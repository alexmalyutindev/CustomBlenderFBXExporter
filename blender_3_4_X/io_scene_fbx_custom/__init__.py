...
class ARibeiro_ImportFBX(bpy.types.Operator, ImportHelper):
    """Load a FBX file"""
    bl_idname = "import_scene.aribeirofbx"
    bl_label = "Import FBX(@aRibeiro)"# [Alessandro]
...
class ARIBEIROFBX_PT_import_include(bpy.types.Panel):
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "IMPORT_SCENE_OT_aribeirofbx"
...
class ARIBEIROFBX_PT_import_transform_manual_orientation(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Manual Orientation"
    bl_parent_id = "ARIBEIROFBX_PT_import_transform"
...
class ARIBEIROFBX_PT_import_animation(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Animation"
    bl_parent_id = "FILE_PT_operator"
...
class ARIBEIROFBX_PT_import_armature(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Armature"
    bl_parent_id = "FILE_PT_operator"
...
@orientation_helper(axis_forward='-Z', axis_up='Y')
class ARibeiro_ExportFBX(bpy.types.Operator, ExportHelper):
    """Write a FBX file"""
    bl_idname = "export_scene.aribeirofbx"
    bl_label = "Export FBX(@aRibeiro)"# [Alessandro]
    bl_options = {'UNDO', 'PRESET'}
    ...
    add_leaf_bones: BoolProperty(
            ...
            # [Alessandro]
            default=False # default=True # False for commit!
            )
    primary_bone_axis: EnumProperty(
            name="Primary Bone Axis",
            items=(('X', "X Axis", ""),
...
class ARIBEIROFBX_PT_export_main(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = ""
    bl_parent_id = "FILE_PT_operator"
...
class ARIBEIROFBX_PT_export_include(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Include"
    bl_parent_id = "FILE_PT_operator"
...
class ARIBEIROFBX_PT_export_transform(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Transform"
    bl_parent_id = "FILE_PT_operator"
...
class ARIBEIROFBX_PT_export_geometry(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Geometry"
    bl_parent_id = "FILE_PT_operator"
...
class ARIBEIROFBX_PT_export_bake_animation(bpy.types.Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
...
def menu_func_export(self, context):
    self.layout.operator(ARibeiro_ExportFBX.bl_idname, text="FBX @aRibeiro (.fbx)")# [Alessandro]


classes = (
    ARibeiro_ImportFBX,
    ARIBEIROFBX_PT_import_include,
    ARIBEIROFBX_PT_import_transform,
    ARIBEIROFBX_PT_import_transform_manual_orientation,
    ARIBEIROFBX_PT_import_animation,
    ARIBEIROFBX_PT_import_armature,
    ARibeiro_ExportFBX,
    ARIBEIROFBX_PT_export_main,
    ARIBEIROFBX_PT_export_include,
    ARIBEIROFBX_PT_export_transform,
